...
namespace TP_FusionVox.Controllers
{
    public class GenreMusicalController : Controller
    {
        ...
        private readonly IStringLocalizer<GenreMusicalController> _localizer;
        private IGenreMusicalService _serviceGM { get; set; }
        private IArtisteService _serviceA { get; set; }

        public GenreMusicalController(IGenreMusicalService serviceGM,
                                IArtisteService serviceA,
                                IWebHostEnvironment webHostEnvironment,
                                IStringLocalizer<GenreMusicalController> localizer)
        {
