...
namespace TP_FusionVox.Migrations
{
    ...
    [Migration("20230824192745_AjoutDonneesConfidentiellesAgentSeed")]
    partial class AjoutDonneesConfidentiellesAgentSeed
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TP_FusionVox.Models.Agent", b =>
                {
                    ...
                    b.Property<int>("DonneesConfidentiellesAgentID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DonneesConfidentiellesAgentID")
                        .IsUnique();
            ...
            modelBuilder.Entity("TP_FusionVox.Models.DonneesConfidentiellesAgent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("NumeroDeContrat")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.ToTable("DonneesConfidentiellesAgent");
            ...
            modelBuilder.Entity("TP_FusionVox.Models.Agent", b =>
                {
                    b.HasOne("TP_FusionVox.Models.DonneesConfidentiellesAgent", "DonneesConfidentiellesAgent")
                        .WithOne("Agent")
                        .HasForeignKey("TP_FusionVox.Models.Agent", "DonneesConfidentiellesAgentID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DonneesConfidentiellesAgent");
                });
